 ...
 */
class GlobalConfigurationBag implements ConfigurationBagInterface {
   ...
   * {@inheritDoc}
   */
  public static function getInstance(): GlobalConfigurationBag {
  ...
  protected function checkData(string $configData): array {
    ...
    if (empty($configData['files_config'])) {
      throw new \Exception('Wrong global configuration data');
    }
