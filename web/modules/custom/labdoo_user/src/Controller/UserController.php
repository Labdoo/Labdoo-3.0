...
class UserController extends ControllerBase {
  ...
  public function metrics(User $user): array {
    ...
    return [
      ...
      '#user_id' => $userId,
      '#num_doojects' => $numDoojects,
      '#num_dootrips' => $numDootrips,
      '#num_edoovillages' => $numEdoovillages,
      '#num_hubs' => $numHubs,
      '#num_wikis' => $numWikis,
      '#footprint_carbon' => $footprintCarbon,
      '#footprint_trees' => $footprintTrees,
      '#footprint_gas' => $footprintGas,
      '#footprint_plastic' => $footprintPlastic,
      '#footprint_water' => $footprintWater,
      '#footprint_aluminum' => $footprintAluminum,
      '#footprint_gold' => $footprintGold,
      '#footprint_silver' => $footprintSilver,
      '#footprint_palladium' => $footprintPalladium,
      '#footprint_copper' => $footprintCopper,
      '#footprint_cobalt' => $footprintCobalt,
      '#footprint_chemical' => $footprintChemical,
    ];
  }
